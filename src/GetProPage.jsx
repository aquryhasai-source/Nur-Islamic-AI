...
const PRO_FEATURES = [
  { icon: "✦", label: "Unlimited AI reflections" },
  { icon: "🔖", label: "Bookmarks — Quran & Hadith" },
  { icon: "🧭", label: "Qibla direction finder" },
  { icon: "📅", label: "Islamic calendar" },
  { icon: "🕐", label: "Full chat history" },
  { icon: "⭐", label: "Priority features forever" },
];
    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%", overflow:"hidden" }}>
      ...
      <div style={{ flex:1, overflowY:"auto", padding:"0 0 40px" }}>
        ...
        <div style={{ padding:"32px 24px 28px", textAlign:"center", borderBottom:`1px solid ${goldBdr}` }}>
          ...
          <div style={{ color:goldDim, fontSize:"11px", letterSpacing:"3px", textTransform:"uppercase", marginBottom:"20px" }}>Lifetime Access</div>

          <div style={{ fontSize:"18px", color:gold, fontFamily:"Georgia,serif", marginBottom:"6px" }}>
            طَلَبُ الْعِلْمِ فَرِيضَةٌ
          </div>
          <div style={{ color:textDim, fontSize:"11px", letterSpacing:"1px", marginBottom:"28px" }}>
          ...
          <a href={payUrl} target="_blank" rel="noreferrer"
            ...
            <span>🌙 Unlock NŪR Pro — {price}</span>
        ...
        <div style={{ padding:"24px 20px" }}>
          <div style={{ color:goldDim, fontSize:"10px", letterSpacing:"2px", textTransform:"uppercase", marginBottom:"16px" }}>What you unlock</div>
